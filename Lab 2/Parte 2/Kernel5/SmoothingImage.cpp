...
int main( int argc, char ** argv )
{
 ...
 imwrite("Grupo_FiltroDeMediaK5.jpg", dst);
...
imwrite("Grupo_FiltroDeMedianaK5.jpg", dst);
 ...
 imwrite("Grupo_FiltroGaussianoK5.jpg", dst);
...
imwrite("Grupo_FiltroBilateralK5.jpg", dst);
