...
int main( int argc, char ** argv )
{
 ...
 imwrite("Grupo_FiltroDeMediaK7.jpg", dst);
...
imwrite("Grupo_FiltroDeMedianaK7.jpg", dst);
 ...
 imwrite("Grupo_FiltroGaussianoK7.jpg", dst);
...
imwrite("Grupo_FiltroBilateralK7.jpg", dst);
